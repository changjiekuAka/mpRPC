...
class GetFriendListsRequest :
 ...
 public:
  ...
  void set_usrid(const std::string& value);
  void set_usrid(std::string&& value);
  void set_usrid(const char* value);
  void set_usrid(const void* value, size_t size);
  std::string* mutable_usrid();
  std::string* release_usrid();
  void set_allocated_usrid(std::string* usrid);
  private:
  const std::string& _internal_usrid() const;
  void _internal_set_usrid(const std::string& value);
...
inline const std::string& GetFriendListsRequest::usrid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsRequest.usrid)
  return _internal_usrid();
}
inline void GetFriendListsRequest::set_usrid(const std::string& value) {
  _internal_set_usrid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsRequest.usrid)
}
inline std::string* GetFriendListsRequest::mutable_usrid() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsRequest.usrid)
  return _internal_mutable_usrid();
}
inline const std::string& GetFriendListsRequest::_internal_usrid() const {
  return usrid_.GetNoArena();
}
inline void GetFriendListsRequest::_internal_set_usrid(const std::string& value) {
  
  usrid_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void GetFriendListsRequest::set_usrid(std::string&& value) {
  
  usrid_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.GetFriendListsRequest.usrid)
}
inline void GetFriendListsRequest::set_usrid(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  usrid_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendListsRequest.usrid)
}
inline void GetFriendListsRequest::set_usrid(const void* value, size_t size) {
  
  usrid_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendListsRequest.usrid)
}
inline std::string* GetFriendListsRequest::_internal_mutable_usrid() {
  
  return usrid_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* GetFriendListsRequest::release_usrid() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsRequest.usrid)
  
  return usrid_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void GetFriendListsRequest::set_allocated_usrid(std::string* usrid) {
  if (usrid != nullptr) {
    
  } else {
    
  }
  usrid_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), usrid);
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsRequest.usrid)
}
