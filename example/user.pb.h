...
inline const std::string& RegisterRequest::user_name() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterRequest.user_name)
  return _internal_user_name();
}
inline void RegisterRequest::set_user_name(const std::string& value) {
  _internal_set_user_name(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterRequest.user_name)
}
inline std::string* RegisterRequest::mutable_user_name() {
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterRequest.user_name)
...
inline void RegisterRequest::set_user_name(std::string&& value) {
  ...
  user_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RegisterRequest.user_name)
}
inline void RegisterRequest::set_user_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:fixbug.RegisterRequest.user_name)
}
inline void RegisterRequest::set_user_name(const void* value, size_t size) {
  ...
  user_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.RegisterRequest.user_name)
}
...
inline std::string* RegisterRequest::release_user_name() {
  // @@protoc_insertion_point(field_release:fixbug.RegisterRequest.user_name)
...
inline void RegisterRequest::set_allocated_user_name(std::string* user_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegisterRequest.user_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegisterRequest::_internal_age() const {
  return age_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegisterRequest::age() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterRequest.age)
  return _internal_age();
}
inline void RegisterRequest::_internal_set_age(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  age_ = value;
}
inline void RegisterRequest::set_age(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_age(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterRequest.age)
}

// string user_msg = 3;
inline void RegisterRequest::clear_user_msg() {
  user_msg_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline const std::string& RegisterRequest::user_msg() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterRequest.user_msg)
  return _internal_user_msg();
}
inline void RegisterRequest::set_user_msg(const std::string& value) {
  _internal_set_user_msg(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterRequest.user_msg)
}
inline std::string* RegisterRequest::mutable_user_msg() {
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterRequest.user_msg)
  return _internal_mutable_user_msg();
}
inline const std::string& RegisterRequest::_internal_user_msg() const {
  return user_msg_.GetNoArena();
}
inline void RegisterRequest::_internal_set_user_msg(const std::string& value) {
  
  user_msg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void RegisterRequest::set_user_msg(std::string&& value) {
  
  user_msg_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RegisterRequest.user_msg)
}
inline void RegisterRequest::set_user_msg(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  user_msg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:fixbug.RegisterRequest.user_msg)
}
inline void RegisterRequest::set_user_msg(const char* value, size_t size) {
  
  user_msg_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:fixbug.RegisterRequest.user_msg)
}
inline std::string* RegisterRequest::_internal_mutable_user_msg() {
  
  return user_msg_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* RegisterRequest::release_user_msg() {
  // @@protoc_insertion_point(field_release:fixbug.RegisterRequest.user_msg)
  
  return user_msg_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void RegisterRequest::set_allocated_user_msg(std::string* user_msg) {
  if (user_msg != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegisterRequest.user_msg)
}
